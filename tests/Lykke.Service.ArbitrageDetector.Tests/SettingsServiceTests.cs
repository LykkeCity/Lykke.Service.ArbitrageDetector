    ...
    public class SettingsServiceTests
    {
        ...
        public async Task SettingsSetAllTest()
        {
            var startupSettings = new Settings
            {
                ...
                LykkeArbitragesExecutionInterval = new TimeSpan(0, 0, 0, 7),
            ...
            await settingsService.SetAsync(startupSettings);
            ...
            var settings = new Settings
            {
                ...
                LykkeArbitragesExecutionInterval = new TimeSpan(0, 0, 0, 3),
        ...
        private ISettingsRepository SettingsRepository(Settings settings)
        {
            ...
            var settingsRepositoryObj = settingsRepository.Object;

            return settingsRepositoryObj;
        }
    }
}
